...
Статус: `done, not committed` на 2026-09-23.
...
пройденный гейт. Реализация намеренно не закоммичена на ветке
`r3-engine-spike`, базовый HEAD `7f72513582a15732196e7f397f04413ad7392deb`.
Не делать commit или push без нового явного запроса.
